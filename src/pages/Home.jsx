...
const products = [
  ...
  },
  {
    ...
    description:
      "Rich and creamy whipped butter for your skin. Whipped to perfection.",
  },
  {
  ...
  },
  {
    ...
    image: Boxed_oil,
    description:
      "Essential oils for daily skincare routine. Try some of our various scents!",
  },
  {
    name: "Surveys Are In",
    image: Survey,
    description:
      "Your feedback matters. See what others are saying about our natural body butters!",
  },
];

function Home() {
  return (
    <div className="font-sans bg-yellow-100 p-10 padding-custom">
      <div className="text-center mb-10 bg-amber-900 text-white py-6">
        <h1 className="text-4xl font-bold">Welcome to Essential'd Skin Care</h1>
      </div>
