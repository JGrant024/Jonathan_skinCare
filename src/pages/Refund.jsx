  ...
  return (
    ...
    >
      <p className="text-center">
        Refund policy We have a 30-day return policy, which means you have 30
        days after receiving your item to request a return. To be eligible for a
        ...
        need the receipt or proof of purchase. To start a return, you can
        contact us at essentialdskin@gmail.com. If your return is accepted,
        we’ll send you a return shipping label, as well as instructions on how
        and where to send your package. Items sent back to us without first
        requesting a return will not be accepted. You can always contact us for
        any return question at essentialdskin@gmail.com. Damages and issues
        ...
        we can evaluate the issue and make it right. Exceptions / non-returnable
        ...
        returns on sale items or gift cards. Exchanges The fastest way to ensure
        you get what you want is to return the item you have, and once the
        return is accepted, make a separate purchase for the new item. Refunds
